const msgs = {
  en: {
    ...
    update_dmg_detail: 'Download the new DMG and drag it to your Applications folder.',
    update_download_install: 'Download & Install',
    update_open_releases: 'Open download page',
    ...
    update_restarting_msg: 'LightCutVidz will close and reopen automatically with the new version.',
    update_no_config_msg: 'Auto-update is not available for this build. Download the latest version from GitHub.',
  ...
  fr: {
    ...
    update_dmg_detail: 'Téléchargez le nouveau DMG et faites-le glisser dans votre dossier Applications.',
    update_download_install: 'Télécharger et installer',
    update_open_releases: 'Ouvrir la page de téléchargement',
    ...
    update_restarting_msg: 'LightCutVidz va se fermer et redémarrer automatiquement avec la nouvelle version.',
    update_no_config_msg: 'La mise à jour automatique n\'est pas disponible pour cette version. Téléchargez la dernière version depuis GitHub.',
