...
const { splitWordsProportional, splitCharsProportional, assColor, assColorTag, expandCuesToEvents, remapEventsToKeptSegments, toAssTime, buildAssContent, buildSubtitlesFilter, } = requireSrc('main/lib/subtitles.js')
