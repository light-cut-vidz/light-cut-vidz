#!/usr/bin/env bash
# LightCutVidz — one-line uninstaller for macOS and Linux.
#
#   curl -fsSL https://raw.githubusercontent.com/light-cut-vidz/light-cut-vidz/main/uninstall.sh | bash
#
...
TAP="light-cut-vidz/tap"
CASK="light-cut-vidz"
APP_NAME="LightCutVidz"
APP_SLUG="lightcutvidz"
DEB_PACKAGE="lightcutvidz"
ICON_SIZE="512x512"
